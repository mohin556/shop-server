...
app.patch('/orders/:id/status', async (req, res) => {
  ...
  try {
    ...
    //         category: { $first: '$cardItems.category' }, // Optionally get the category
    //         quantity: { $sum: 1 }, // Sum the quantity
    //         totalRevenue: { $sum: { $toDouble: '$cardItems.price' } } // Convert price to double and sum the total revenue
    //       }
    //     },
    //     {
    //       $project: {
    ...
    //         _id: '$cardItems._id', // Group by item ID
    //         itemName: { $first: '$cardItems.name' }, // Get the item name
    //         price: { $first: '$cardItems.price' }, // Get the item price
    //         category: { $first: '$cardItems.category' }, // Optionally get the category
    //         quantity: { $sum: 1 }, // Sum the quantity
    //         totalRevenue: { $sum: '$cardItems.price' } // Sum the total revenue
    //       }
    //     },
    //     {
    //       $project: {
    ...
    //     {
    //       $addFields: {
    //         itemIds: { $toObjectId: '$itemIds' } // Convert string to ObjectId
    //       }
    //     },
    //     {
    //       $lookup: {
    ...
    //     {
    //       $group: {
    //         _id: '$cardItems.category',
    //         quantity:{ $sum: 1},
    //         revenue: { $sum: '$cardItems.price'}
    //       }
    //     }
    //   ]).toArray();
